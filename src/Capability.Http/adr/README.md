# Architecture Decision Records — Forge.Capability.Http

Slice-local decisions for the HTTP integration slice. Read after the [root ADRs](../../../adr/), [Capability ADRs](../../Capability/adr/), and [Authorization.Http ADRs](../../Authorization.Http/adr/).
