...
namespace Forge.Operations.Generators.Tests;
...
/// Moved from Forge.Operations.Tests to isolate generator tests from behavioral tests
/// and to remove the Forge.Operations.Tests dependency on Microsoft.CodeAnalysis.CSharp.
/// </summary>
